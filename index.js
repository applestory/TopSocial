...
import { profile, highline, card, message, request } from "./data/db.json"; //仅在vite框架里，才能用这种方法拿到数据
...
card.forEach((element) => {
  ...
  create_contorl_structure(doms.info_control, element.control);
